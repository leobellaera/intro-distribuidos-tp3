...
class Topology:
    ...
    def get_shortest_path_output_port(self, dpid_from, dpid_to):
        ...
        shortest_path = self._shortest_path(
            dpid_to_str(dpid_from), dpid_to_str(dpid_to)
        )
    ...
    def _shortest_path(self, dpid_from, dpid_to):
        ...
        while queue:
            ...
            neigh_len = len(self.graph[dpid_u][NEIGHBOURS])

            for dpid_v in sample(self.graph[dpid_u][NEIGHBOURS], neigh_len):
